...
public class KeyedStreams {
    public static void main(String[] args) throws Exception {
        ...
        DataStream<String> inputData = env.readTextFile("path/to/file.csv");
        DataStream<String> stockRecords = inputData.filter((FilterFunction<String>) line ->
        ...
        KeyedStream<Tuple2<String, Double>, String> keyedClosePrices = closePricesPerMonth.keyBy(value -> value.f0);
